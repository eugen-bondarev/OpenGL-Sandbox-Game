...
{
	Werwel::TextAsset vsCode("assets/shaders/terrain/composition_shader.vs", NF_ROOT);
	Werwel::TextAsset fsCode("assets/shaders/terrain/composition_shader.fs", NF_ROOT);
	...
	Werwel::TextAsset vsSky("assets/shaders/sky/sky.vs", NF_ROOT);
	Werwel::TextAsset fsSky("assets/shaders/sky/sky.fs", NF_ROOT);
