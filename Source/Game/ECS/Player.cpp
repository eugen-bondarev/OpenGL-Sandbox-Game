...
void Player::Update() {
	...
	if (NF_KEY_PRESSED(NF_KEY_ARROW_LEFT)) { entity->animator->SetFrame(entity->animator->GetFrame() - 1); entity->animator->SetAttackFrame(7); world->GetMap()->blocksUpdated = true; }
	if (NF_KEY_PRESSED(NF_KEY_ARROW_RIGHT)) { entity->animator->SetFrame(entity->animator->GetFrame() + 1); entity->animator->SetAttackFrame(7); world->GetMap()->blocksUpdated = true; }
